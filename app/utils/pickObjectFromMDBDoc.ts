...
export const pickExercise = (exercise: IExercise) => ({ id: exercise._id, ..._.pick(exercise, ['title', 'each_side', 'type', 'repeats', 'hours', 'time', 'weight', 'description', 'image', 'mass_unit', 'is_in_workout', 'in_workouts', 'archived']) });
